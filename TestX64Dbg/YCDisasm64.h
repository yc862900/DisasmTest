...
#ifdef YCDISASM64_EXPORTS
#define YCDISASM64_API __declspec(dllexport)
#else
#define YCDISASM64_API __declspec(dllimport)
#endif
...
YCDISASM64_API YCINT YCDisasm(YCDISASM *disasm);  //return size of decoded data
